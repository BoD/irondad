    ...
    public void handleChannelMessage(final Connection connection, final String channel, final String fromNickname, String text, List<String> textAsList,
        ...
        while (matcher.find()) {
            ...
            mThreadPool.submit(new Runnable() {
                ...
                public void run() {
                    try {
                        String html = HttpRequest.get(url).header("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.52 Safari/537.36").body();
